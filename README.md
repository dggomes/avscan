...
- Action tiles: Scan All, Scan Checked, Update Definitions, Update App, View Logs, Add Folder. Add Folder opens an inline browser for local folders, mapped drives, known network locations, pasted UNC paths, and adding all discovered mapped drives at once.
