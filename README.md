...
- Action tiles: Scan All, Scan Checked, Update Definitions, Update App, View Logs, Add Folder. Add Folder supports local folders, known network locations, pasted UNC paths, an in-app folder browser, and adding all discovered mapped drives at once.
